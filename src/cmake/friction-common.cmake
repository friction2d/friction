...
if(UNIX)
    add_compile_options(-Wall -Wextra -Wno-unused-private-field -Werror=inconsistent-missing-override)
    if(NOT ${LINUX_DEPLOY})
...
if(WIN32)
    ...
    if(${BUILD_SKIA})
        set(SKIA_LIBRARIES_DIRS ${CMAKE_CURRENT_BINARY_DIR}/../skia)
    else()
        set(SKIA_LIBRARIES_DIRS ${SKIA_LIB_PATH})
    endif()
endif()
